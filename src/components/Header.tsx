        ...
        <div className="flex items-center gap-3">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" aria-hidden>
              ...
              />
              <path
                d="M21 21V5a1 1 0 00-1-1h-4V3H8v1H4a1 1 0 00-1 1v16"
                stroke="white"
                strokeWidth="1.2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M7 10h2M7 14h2M7 6h2M11 6h2M11 10h2M11 14h2"
                stroke="white"
                strokeWidth="1.4"
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        <div className="flex items-center gap-4">
          <div className="relative" ref={menuRef}>
            ...
            <div
              ...
              aria-hidden={!open}
              className={`origin-top-right z-40 absolute right-0 mt-2 w-56 rounded-lg bg-white border border-slate-100 shadow-lg overflow-hidden transform transition-all ${
                open
